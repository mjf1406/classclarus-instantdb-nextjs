...
interface StudentParentManagerProps {
    students: StatMember[];
    parents: StatMember[];
...
export function StudentParentManager({
    students,
    parents,
    organizationId,
    adminIds,
    onChange,
}: StudentParentManagerProps) {
    ...
    // Query to get student-parent relationships and student's classes
